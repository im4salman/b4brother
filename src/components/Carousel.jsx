...
const Carousel = ({ mediaItems = [], autoPlay = true }) => {
  ...
  if (mediaItems.length === 0) {
    return (
      <div className="w-full h-screen pt-24 md:pt-28 bg-gray-200 flex items-center justify-center">
  ...
  return (
    <div
      className="relative w-full h-screen overflow-hidden pt-24 md:pt-28"
      role="region"
